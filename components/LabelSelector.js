    ...
    return (
        <div className="space-y-4">
            <div>
                ...
                <div className="p-3 bg-gray-50/50 dark:bg-gray-800/40 rounded-xl border border-gray-200 dark:border-gray-700/50">
                        ...
                        {predefinedLabels.map((lbl) => (
                            <button
                                ...
                                className={`px-3 py-1.5 rounded-full text-[11px] sm:text-xs font-bold transition-all duration-200 cursor-pointer shadow-sm ${selectedLabels.includes(lbl)
                                    ...
                                    : "bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600 border border-gray-200 dark:border-gray-600 hover:border-gray-300 dark:hover:border-gray-500 hover:-translate-y-0.5"
                                    }`}
                            >
                                {lbl}
                            </button>
            ...
            <div className="bg-gray-50/30 dark:bg-gray-800/20 p-3 rounded-xl border border-dashed border-gray-300 dark:border-gray-700/60 focus-within:border-violet-400 dark:focus-within:border-violet-600 transition-colors">
                <div className="flex items-center gap-2">
                    <input
                        ...
                        className="w-full px-3 py-2 text-sm bg-white/60 dark:bg-gray-900/40 border border-gray-200 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500/50 dark:text-white transition-all"
                    />
                    <button
                        type="button"
                        onClick={handleAdd}
                        disabled={!customLabel.trim()}
                        className="px-4 py-2 bg-gray-900 dark:bg-white text-white dark:text-gray-900 text-xs font-bold rounded-lg hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed shadow-sm shrink-0"
                    >
                        Add
                    </button>
                </div>
                ...
                {customLabel.trim() && (
                    <div className="mt-3 space-y-2 animate-in fade-in slide-in-from-top-1">
                        <div className="flex flex-wrap gap-2 p-2 bg-white/80 dark:bg-gray-900/60 rounded-lg border border-gray-100 dark:border-gray-800">
                            {customColorOptions.map((opt) => (
                                <button
                                    ...
                                    className={`w-7 h-7 rounded-full cursor-pointer transition-all duration-200 ${selectedColor === opt.value
                                        ? "ring-2 ring-offset-2 ring-offset-white dark:ring-offset-gray-900 ring-violet-500 scale-110 shadow-md"
