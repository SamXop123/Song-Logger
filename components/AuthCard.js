  ...
  return (
    <div className="w-full max-w-xl bg-white/80 dark:bg-slate-900/50 backdrop-blur-xl p-8 rounded-[2rem] shadow-2xl shadow-indigo-500/5 dark:shadow-[0_8px_30px_rgb(0,0,0,0.4)] border border-white/60 dark:border-slate-700/50">
      ...
      <p className="mt-3 text-slate-600 dark:text-slate-300 leading-7">
        Save songs, organize them with labels, and keep your log connected to
        your account.
      </p>

      <div className="mt-5 grid grid-cols-1 sm:grid-cols-3 gap-2.5 text-xs">
        <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white/60 dark:bg-slate-800/40 px-3 py-2 text-slate-600 dark:text-slate-300">
          Private by default
        </div>
        <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white/60 dark:bg-slate-800/40 px-3 py-2 text-slate-600 dark:text-slate-300">
          On any device
      ...
      <div className="mt-6 rounded-2xl border border-slate-200 dark:border-slate-700 bg-slate-50/70 dark:bg-slate-800/40 p-4">
        ...
        <ul className="mt-3 space-y-2 text-sm text-slate-600 dark:text-slate-300">
          <li>Your song log stays private to your account.</li>
          <li>Your entries are available across your devices.</li>
          <li>You can import existing local songs after signing in.</li>
        </ul>
      </div>
      ...
      <p className="mt-3 text-center text-xs text-slate-500 dark:text-slate-400">
        You stay in control. Sign out anytime from your account menu.
      </p>
    </div>
  );
}
