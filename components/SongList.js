...
const SongList = memo(function SongList({ songs, onEdit, onDelete, onDeleteAll, onImportCSV, onExportCSV }) {
    ...
    return (
        <div className="bg-white/80 dark:bg-gray-900/70 backdrop-blur-xl p-6 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] border border-white/40 dark:border-gray-700/50 w-full h-full flex flex-col transition-all">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100 flex items-center gap-2">
                    ...
                    Your Log
                    <span className="text-sm font-medium text-gray-400 dark:text-gray-500 bg-gray-100 dark:bg-gray-800 px-2 py-0.5 rounded-full ml-1">
                        {songs.length}
                    </span>
                </h2>
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    <button
                        ...
                        className="text-xs font-semibold px-3 py-1.5 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-violet-300 dark:hover:border-violet-600 transition-all cursor-pointer shadow-sm"
                        title="Import CSV"
                    >
                        Import
                    </button>
                        ...
                        <div>
                            ...
                            <div className="flex gap-2">
                                ...
                                <button
                                    ...
                                    className="bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 border border-gray-300 dark:border-gray-600 px-4 py-1.5 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer text-xs font-semibold transition-all"
                                >
                                    Cancel
                                </button>
                            </div>
            ...
            {songs.length === 0 ? (
                <div className="flex-grow flex flex-col items-center justify-center text-center p-8 border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-2xl bg-gray-50/50 dark:bg-gray-800/30">
                    ...
                    <p className="text-gray-900 dark:text-gray-200 font-semibold mb-1">Your log is empty</p>
