  ...
  const handleSaveEdit = useCallback(
    ...
    return (
        <div className="min-h-screen flex items-start justify-center p-4 relative overflow-hidden">
            ...
            {/* Main glass wrapper */}
            <div className="flex flex-col mt-4 sm:mt-8 lg:flex-row gap-6 w-full max-w-5xl z-10 transition-all duration-500">
                {/* Left panel - Add/Edit Form */}
                <div className="bg-white/80 dark:bg-slate-900/40 backdrop-blur-xl p-6 rounded-[2rem] shadow-2xl shadow-indigo-500/5 dark:shadow-[0_8px_30px_rgb(0,0,0,0.4)] border border-white/60 dark:border-slate-700/50 w-full lg:w-[45%] flex flex-col transition-all">
